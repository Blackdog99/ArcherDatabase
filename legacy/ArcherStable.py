...
class Archer_Portal():
    ...
    def edit_box(self):
        ...
        # Description might not always be available, so check before accessing the index
        description = selected_values[7] if len(selected_values) > 7 else ''
        ...
        Button(self.edit_root, text='Save Changes to Record', command=lambda:
            self.edit_record(new_bcode.get(), new_title.get(), new_keyword1.get(), new_keyword2.get(), new_keyword3.get(),
                         new_plocation.get(), new_vlocation.get(), new_description.get(), bcode, title, keyword1, keyword2,
    ...
    def edit_record(self, new_bcode, new_title, new_keyword1, new_keyword2, new_keyword3, new_plocation, new_vlocation,
        ...
        parameters = (new_bcode, new_title, new_keyword1, new_keyword2, new_keyword3, new_plocation,
