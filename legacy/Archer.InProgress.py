...
class Archer_Portal():
    ...
    def edit_box(self):
        ...
        try:
            ...
            bcode = item_values[0]
            title = item_values[1]
            keyword1 = item_values[2]
            keyword2 = item_values[3]
            keyword3 = item_values[4]
            plocation = item_values[5]
            vlocation = item_values[6]
            description = item_values[7]
    ...
    def edit_record(self, new_bcode, new_title, new_keyword1, new_keyword2, new_keyword3, new_plocation, new_vlocation,
        ...
        parameters = (new_bcode, new_title, new_keyword1, new_keyword2, new_keyword3, new_plocation,
                      ...
                      bcode, title, keyword1, keyword2, keyword3, plocation, vlocation, description)
        self.run_query(query, parameters)
